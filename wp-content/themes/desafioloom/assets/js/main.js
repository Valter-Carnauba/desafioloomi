...
jQuery(document).ready(function ($) {
    ...
    function carregarPosts(reset = false) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                $('#btnVerMais').text('Carregando...');
            },
            success: function (res) {
                if (reset) {
                    $('.more-material .row').html(res);
                } else {
                    $('.more-material .row').append(res);
                }
                offset += postsPerPage;
    ...
    $('#selectAno, #selectCategoria').on('change', function () {
        carregarPosts(true);
    });
